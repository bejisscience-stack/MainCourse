...
export const emailTemplates: Record<string, EmailTemplate> = {
  ...
  lecturerApproved: {
    subject: {
      en: "Lecturer Account Approved!",
      ge: "ლექტორის ანგარიში დამტკიცებულია!",
    },
    html: (data) =>
      emailWrapper(`
      ...
      <p style="margin: 32px 0;">
        <a href="${SITE_URL}/lecturer/dashboard" style="${buttonStyle}">Go to Dashboard</a>
      </p>
    `),
    text: (data) =>
  ...
  lecturerRejected: {
    subject: {
      en: "Lecturer Account Update",
      ge: "ლექტორის ანგარიშის განახლება",
    },
    html: (data) =>
      emailWrapper(`
