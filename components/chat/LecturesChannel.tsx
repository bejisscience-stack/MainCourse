    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-gradient-to-b from-gray-900 to-gray-950">
        <div className="text-center">
          ...
          <p className="text-gray-400 font-medium">Loading lectures...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">{videos.length} {videos.length === 1 ? 'video' : 'videos'}</p>
            </div>
        </div>
        {isLecturer && (
          <button
        ...
        {videos.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-16">
            ...
            <p className="text-gray-500 max-w-sm mb-6">
              {isLecturer 
                ? 'Start building your course by uploading your first video lecture.'
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 text-xs">
              {video.progress?.isCompleted ? (
                ...
                <span className="text-gray-500">{Math.round(progress)}% watched</span>
              ) : null}
              {video.duration && (
