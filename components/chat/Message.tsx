...
const Message = memo(function Message({
  ...
  const canMute =
    isLecturer && message.user.id !== currentUserId && !!channelId;
        ...
        >
          ...
          {message.replyPreview && (
            ...
            >
              ...
              <span className="text-emerald-200 font-medium text-[13px]">
                {message.replyPreview.username}
              </span>
              <span className="text-gray-300 truncate text-[13px]">
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              {message.reactions.map((reaction, idx) => {
                ...
                return (
                  ...
                  >
                    <span className="text-lg leading-none transition-transform duration-200 group-hover/reaction:scale-110">
                      {reaction.emoji}
                    </span>
                    <span
                      className={`text-xs font-bold tabular-nums ${hasReacted ? "text-emerald-300" : "text-gray-400"}`}
                    >
                      {reaction.count}
                    </span>
                  </button>
