...
export default function ChannelManagement({
  ...
  const [formData, setFormData] = useState({
    name: "",
    type: "text" as "text" | "voice" | "lectures" | "announcement",
    description: "",
  ...
  const isRequiredChannel = (channel: Channel): boolean => {
    return (
      (channel.type === "lectures" &&
        channel.name.toLowerCase() === "lectures") ||
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    {editingChannel
                      ...
                      : "Add a new channel to your course"}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="lectures">
                      {t("channels.lecturesChannel")}
                    </option>
                    <option value="announcement">
                      {t("channels.announcementChannel")}
                    </option>
                  </select>
                  <svg
