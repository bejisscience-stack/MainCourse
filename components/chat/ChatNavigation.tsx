  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center space-x-2 px-3 py-1.5 rounded-lg hover:bg-navy-800/60 transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-400/50"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-navy-950/90 border border-navy-700/60 rounded-xl shadow-soft-xl py-2 z-50">
          {languages.map((lang) => (
            <button
              key={lang.code}
              onClick={() => {
...
export default function ChatNavigation() {
  ...
  return (
    <div className="h-12 bg-navy-950/80 backdrop-blur-xl border-b border-navy-800/60 flex items-center justify-between px-4 shadow-soft z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="h-6 w-px bg-navy-800/70"></div>
