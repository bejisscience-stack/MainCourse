...
function GlobalCommerceBackgroundComponent() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const type =
        SHIPPING_TYPES[Math.floor(Math.random() * SHIPPING_TYPES.length)];
      ...
      setShippingIcons((prev) => [
        ...prev.slice(-MAX_SHIPPING_ICONS + 1),
        newShippingIcon,
      ]);
    ...
    switch (type) {
      case "package":
        return (
          <svg {...commonProps}>
            <path
              d="M21 8a2 2 0 0 0-1-1.73L12 2 4 6.27A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73L12 22l8-4.27A2 2 0 0 0 21 16Z"
              stroke="currentColor"
              strokeWidth="1.5"
            />
            <path
      ...
      case "plane":
        return (
          <svg {...commonProps}>
            <path
              d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1 .5-3 1-4.5 2.5L13 9l-8.2-1.8c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5.1 1 .6 1.1L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 2.8 5c.1.5.6.8 1.1.6l.5-.3c.4-.2.6-.6.5-1.1Z"
              stroke="currentColor"
              strokeWidth="1.5"
            />
          </svg>
      ...
      case "ship":
        return (
          <svg {...commonProps}>
            <path
              d="M2 21c.6.5 1.2 1 2.5 1 4.5 0 8-3.5 8-10S9 2 9 2s4.5 5 4.5 10-3.5 10-8 10c-1.3 0-1.9-.5-2.5-1Z"
              stroke="currentColor"
              strokeWidth="1.5"
            />
            <path
              d="M19.5 14.5c-.9-2.2-1.4-4.8-1.5-7.5M22 12c-1 0-3-1-3-3s2-3 3-3 3 1 3 3-2 3-3 3"
              stroke="currentColor"
              strokeWidth="1.5"
            />
          </svg>
      ...
      case "truck":
        return (
          <svg {...commonProps}>
            ...
            />
            <path
              d="M15 18H9M19 18h2a1 1 0 0 0 1-1v-3.5c0-.3-.1-.6-.4-.8l-2.6-2.6A1 1 0 0 0 18.5 10H14"
              stroke="currentColor"
              strokeWidth="1.5"
            />
            <circle
