...
function Navigation() {
  ...
  useEffect(() => {
    if (isProfileMenuOpen && profileButtonRef.current) {
      ...
      // Calculate right position - ensure dropdown stays within viewport
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            {loading ? (
              <div className="text-charcoal-500 dark:text-gray-500 text-sm">
                {t("common.loading")}
              </div>
            ) : user ? (
              <div className="relative">
                ...
                {isProfileMenuOpen && (
                  <>
                    ...
                    />
                    <div
                      className="fixed w-56 min-w-[224px] bg-white dark:bg-navy-700 rounded-xl shadow-2xl dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-charcoal-200 dark:border-navy-600/80 backdrop-blur-sm dark:backdrop-blur-md py-2 z-50 overflow-hidden"
                      style={{
                    ...
                    >
                      <div className="px-4 py-3 border-b border-charcoal-200 dark:border-navy-600/60 bg-charcoal-50/30 dark:bg-navy-600/20">
                        ...
                        {userRole === "admin" && (
                          <span className="inline-block mt-2 px-2 py-0.5 text-xs font-medium bg-charcoal-100 dark:bg-navy-600 text-charcoal-700 dark:text-gray-200 rounded-md border border-charcoal-300 dark:border-navy-500">
                            {t("nav.admin")}
                          </span>
                        )}
                      </div>
                      <div className="py-1.5">
                        ...
                        <div className="border-t border-charcoal-200 dark:border-navy-600/60 my-1.5"></div>
                        <button
                          onClick={() => {
                            setIsProfileMenuOpen(false);
                            handleSignOut();
                          ...
                          className="w-full flex items-center px-4 py-2.5 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                        >
                          <svg
                        ...
                        {signOutError && (
                          <div className="px-4 py-2 text-xs text-red-600 dark:text-red-400 bg-red-50/50 dark:bg-red-500/10 rounded-md mx-2 mt-1">
                            {signOutError}
                          </div>
                        )}
                      </div>
          ...
          <div className="md:hidden py-4 border-t border-charcoal-100/50 dark:border-navy-800/50">
            <div className="flex flex-col space-y-3">
              ...
              <div className="pt-4 border-t border-charcoal-100/50 dark:border-navy-800/50">
                ...
                {loading ? (
                  <div className="text-charcoal-500 dark:text-gray-500 text-sm text-center py-2">
                    {t("common.loading")}
                  </div>
                ) : user ? (
