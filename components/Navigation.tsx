                      ...
                      <div className="py-1.5">
                        {userRole === 'lecturer' ? (
                          <>
                            ...
                            >
                              <svg className="w-5 h-5 mr-3 text-charcoal-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {signOutError && (
                          <div className="px-4 py-2 text-xs text-red-600 dark:text-red-400 bg-red-50/50 dark:bg-red-500/10 rounded-md mx-2 mt-1">{signOutError}</div>
                        )}
                      </div>
                    </div>
                  </>
