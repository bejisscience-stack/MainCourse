...
export function useRealtimeBundleEnrollmentRequests({
  ...
  useEffect(() => {
    ...
    console.log(
      "[RT Bundle Enrollment] Setting up subscription for user:",
      userId,
    );
    ...
    const channel = supabase
      ...
      .on(
        ...
        async (payload) => {
          console.log(
            "[RT Bundle Enrollment] Real-time update received:",
            payload,
          );
          ...
          if (
            ...
            console.error(
              "[RT Bundle Enrollment] Invalid payload: missing new.id",
            );
            return;
          }
          ...
          if (error || !request) {
            console.error(
              "[RT Bundle Enrollment] Error fetching updated request:",
              error,
            );
            return;
          }
