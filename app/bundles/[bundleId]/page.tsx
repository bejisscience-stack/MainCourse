...
export default function BundleEnrollmentPage() {
  ...
  const bundleAsCourse = {
    ...
    // value from the sum of individual course prices would diverge from
    // what's charged.
          ...
          <div className="bg-white dark:bg-navy-800 border-2 border-emerald-200 dark:border-emerald-700/50 rounded-lg p-8 shadow-lg">
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-charcoal-950 dark:text-white mb-4">
                {t("bundles.bundleIncludes")}
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {bundleCourses.map((course: any, idx: number) => (
                  <div
                    key={idx}
                    className="border border-charcoal-200 dark:border-navy-700 rounded-lg p-4 bg-white dark:bg-navy-700/50"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <h3 className="font-bold text-charcoal-950 dark:text-white mb-1">
                          {course.title}
                        </h3>
                        {course.description && (
            ...
            <div className="bg-emerald-50 dark:bg-emerald-500/20 rounded-lg p-6 mb-6 border border-emerald-200 dark:border-emerald-800/50">
              <div className="flex items-center justify-between">
                {(() => {
                  ...
                  return (
                    <div>
                      <p className="text-sm text-charcoal-600 dark:text-gray-400 mb-1">
                      ...
                      <div className="flex items-baseline flex-wrap gap-x-2">
                        ...
                        {showDiscounted && bundle.original_price && (
                          <span className="text-base text-charcoal-400 dark:text-gray-500 line-through">
                      ...
                      {!showDiscounted && totalOriginalPrice > headerAmount && (
                        <>
            ...
            {isEnrolled ? (
              ...
              <button
                onClick={() => {
                  ...
                  if (!user) {
                    router.push(
                      `/login?redirect=${encodeURIComponent(`/bundles/${bundleId}`)}`,
                    );
                    return;
                  }
