...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check for redirect parameter (SEC-01: validate to prevent open redirect)
      const redirectTo = validateRedirectUrl(searchParams.get("redirect"));
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#fafafa] to-white dark:from-navy-950 dark:to-navy-900 px-4 py-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full space-y-8 bg-white dark:bg-navy-800 p-8 rounded-2xl shadow-xl border border-charcoal-100 dark:border-navy-700/50">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {searchParams.get("message") === "signupSuccess" && (
            <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 px-4 py-3 rounded-lg text-sm animate-in fade-in">
              <div className="flex items-start">
                <svg
                  className="w-5 h-5 mr-2 flex-shrink-0 mt-0.5"
                ...
                <p>{t("auth.signupSuccessMessage")}</p>
              </div>
            </div>
          )}
          ...
          {inAppBrowser?.isInApp ? (
            /* In-app browser detected: Google OAuth will fail with disallowed_useragent.
               Hide the Google button and show guidance instead. */
            <div
              role="note"
            ...
            >
              ...
              {/Android/i.test(
                ...
                <a
                  href="intent://swavleba.ge/login#Intent;scheme=https;package=com.android.chrome;end"
