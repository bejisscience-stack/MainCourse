...
-- ============================================
-- Migration 019: Add Unique Username to Profiles
-- ============================================
-- Add username column (nullable initially to allow migration of existing data)
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS username TEXT;

-- Migrate existing full_name data to username (if full_name exists, use it; otherwise use email prefix)
UPDATE public.profiles 
