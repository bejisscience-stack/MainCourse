-- DATA-02: Redact internal error details from complete_keepz_payment
-- Previously SQLERRM was returned directly to callers, leaking internals.
...
EXCEPTION WHEN OTHERS THEN
  RAISE WARNING 'complete_keepz_payment failed for order %: %', p_keepz_order_id, SQLERRM;
