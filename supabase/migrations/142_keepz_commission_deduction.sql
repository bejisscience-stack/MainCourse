-- Migration 142: Deduct Keepz processing fee from lecturer payouts
--
-- Adds payment_method_type and keepz_commission columns, then updates the
-- complete_keepz_payment RPC to calculate and deduct the Keepz fee before
-- crediting the lecturer balance.
--
-- Commission rates:
--   card  → 2.5%
--   bank  → 1% (≤100 GEL) or 0.6% capped at 1 GEL (>100 GEL)
--   split → 3%
...
-- Updated RPC with commission deduction
