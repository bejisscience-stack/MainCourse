-- Migration: Fix ALL admin request RPC functions
-- Description: Ensures all admin request fetching RPC functions exist and work correctly
-- This consolidates fixes for enrollment, bundle enrollment, and withdrawal requests
-- Run this migration to fix the issue where pending requests don't show on admin dashboard

-- ============================================
-- PART 1: ENROLLMENT REQUESTS
-- ============================================
...
COMMENT ON FUNCTION public.get_enrollment_requests_admin IS 'Fetches ALL enrollment requests for admins, bypasses RLS via SECURITY DEFINER.';

-- ============================================
-- PART 2: BUNDLE ENROLLMENT REQUESTS
-- ============================================
...
-- ============================================
-- PART 4: VERIFY check_is_admin FUNCTION EXISTS
-- ============================================
